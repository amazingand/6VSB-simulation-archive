...
# 前置: 当前目录含 step3_input.parm7, eq4_npt.rst7, smd.RST, smd_pull_uncleaved.mdin
# ============================================================================
set -euo pipefail
...
PYEOF
  ...
  # 生成段 mdin + RST
  python3 - smd_pull_uncleaved.mdin smd.RST "smd_chunk${NN}.mdin" "smd_chunk${NN}.RST" "$NST" "$NN" "$R2S" "$R2E" <<'PYEOF'
import sys, re
